...
ryu::ryu(SDL_Renderer *renderer, bool opponent, int vol, int level)
{
    gRenderer = renderer;
    assets = loadTexture("playersprite/ryu.png");
    hitjump = Mix_LoadWAV("music/playerssound/ryu_hitjump.wav");
    lost = Mix_LoadWAV("music/playerssound/ryu_lost.wav");
    special = Mix_LoadWAV("music/playerssound/ryu_special.wav");
    stun = Mix_LoadWAV("music/playerssound/ryu_stun.wav");
...
void ryu::idle(int x_opp, int width_opp)
{
    if (idle_flag == false)
    {
